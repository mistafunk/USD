...
{
    typedef UsdPrtImagingRuleAdapter Adapter;
    TfType t = TfType::Define<Adapter, TfType::Bases<Adapter::BaseAdapter> >();
    t.SetFactory< UsdImagingPrimAdapterFactory<Adapter> >();
}

TfTokenVector
UsdPrtImagingRuleAdapter::GetImagingSubprims(UsdPrim const& prim)
{
    return { TfToken() };
}

TfToken
UsdPrtImagingRuleAdapter::GetImagingSubprimType(
        UsdPrim const& prim,
...
UsdPrtImagingRuleAdapter::GetImagingSubprimData(
        UsdPrim const& prim,
        TfToken const& subprim,
...
UsdPrtImagingRuleAdapter::InvalidateImagingSubprim(
        UsdPrim const& prim,
        TfToken const& subprim,
...
bool
UsdPrtImagingRuleAdapter::IsSupported(UsdImagingIndexProxy const* index) const
{
    return index->IsRprimTypeSupported(HdPrimTypeTokens->mesh);
}

SdfPath
UsdPrtImagingRuleAdapter::Populate(UsdPrim const& prim,
...
void
UsdPrtImagingRuleAdapter::TrackVariability(UsdPrim const& prim,
...
HdDirtyBits
UsdPrtImagingRuleAdapter::ProcessPropertyChange(UsdPrim const& prim,
                                             SdfPath const& cachePath,
...
/*virtual*/
VtValue
UsdPrtImagingRuleAdapter::GetPoints(UsdPrim const& prim,
...
/*virtual*/
VtValue
UsdPrtImagingRuleAdapter::GetTopology(UsdPrim const& prim,
                                   SdfPath const& cachePath,
                                   UsdTimeCode time) const
{
    TRACE_FUNCTION();
